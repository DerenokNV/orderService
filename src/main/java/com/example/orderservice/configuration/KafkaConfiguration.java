...
public class KafkaConfiguration {
  ...
  @Bean
  public ProducerFactory<String, OrderEvent> stringKafkaOrderProducerFactory( ObjectMapper objectMapper ) {
  ...
  @Bean
  public ConsumerFactory<String, StatusEvent> kafkaOrderStatusConsumerFactory( ObjectMapper objectMapper ) {
    Map<String, Object> config = new HashMap<>();
  ...
  @Bean
  public ConcurrentKafkaListenerContainerFactory<String, StatusEvent> kafkaOrderStatusConcurrentKafkaListenerContainerFactory(
          ConsumerFactory<String, StatusEvent> kafkaOrderStatusConsumerFactory
  ) {
